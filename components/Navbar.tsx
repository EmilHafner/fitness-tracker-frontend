...
export default function Navbar() {
    ...
    return (
        <div className={""}>
            <Box className={"flex flex-wrap items-center justify-between shadow-xl bg-primary w-full py-4 px-16"}>
                        ...
                        {showLogin ?
                            ...
                            (
                                <Link href={"/auth/login"}>
                                    <Button
                                        className={"shadow-lg hover:bg-accent-muted transition-[1s] py-2 px-8 rounded-2xl bg-accent font-bold"}>
                                        Login
                                    </Button>
                                </Link>
...
function NavbarItem(props: ItemInterface) {
    return (
        <Link href={props.href} className={"font-bold text-lg text-accent py-2 hover:text-accent-muted transition-[1s]"}>
            {props.title}
        </Link>
    )
}