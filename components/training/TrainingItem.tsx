...
import {format, differenceInDays, formatDistanceStrict, intervalToDuration, formatDuration} from "date-fns";
...
export default function TrainingItem(props: TrainingItemInterface) {
    ...
    return (
        <div onClick={onClick} className={"flex justify-center w-5/6 border-4 border-accent-muted px-16 py-4 rounded-xl hover:cursor-pointer hover:shadow-lg hover:border-accent"}>
            <div className={"flex justify-between w-full"}>
                <div className="flex">
                    <div className="relative -left-4 bg-accent w-2 rounded-md">
                </div>
