...
export default function ExerciseEventComponent(props: { exerciseEvent: ExerciseEvent } & { onClick: () => void }) {
    ...
    return (
        <div
            className="flex h-24 w-full flex-row items-center justify-center rounded-lg bg-stone-50 text-lg font-medium shadow-lg hover:cursor-pointer hover:bg-slate-200"
